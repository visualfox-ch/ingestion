...
CREATE INDEX IF NOT EXISTS idx_decision_log_outcome_score
    ON decision_log(outcome_score);

CREATE INDEX IF NOT EXISTS idx_decision_log_outcome_verified
    ON decision_log(outcome_verified);
